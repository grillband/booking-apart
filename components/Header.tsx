  ...
  return (
    <>
        ...
        <div className="container-page flex items-center justify-between py-4 md:py-5">
          <a href="/" className="flex items-center gap-3">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-[11px] font-medium tracking-[0.22em] text-brand-600 uppercase">
                CozyStay
              </span>
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <a
              href="#booking"
              className="rounded-full bg-brand-400 px-5 py-2.5 text-sm font-semibold text-white shadow-soft transition hover:bg-brand-500"
            >
              Book your stay
            </a>
          </div>
      ...
      {showLocationModal && (
        ...
        >
          <div
            className="relative w-full max-w-4xl mx-4 rounded-3xl border border-slate-200 bg-white shadow-[0_20px_60px_rgba(0,0,0,0.2)] p-6"
          ...
          >
            ...
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Our Location</h2>
      ...
      {showFacilitiesModal && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-xl font-semibold text-slate-900 mb-4">Facilities included</h2>
